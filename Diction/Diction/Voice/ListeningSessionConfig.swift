...
struct ListeningSessionConfig: Equatable {
  ...
  /// real category change away from `.playAndRecord`, applied to the still-active
  /// session, which is what clears iOS's post-VPIO output attenuation. See
  /// `NarrationSessionConfig` for the story.
